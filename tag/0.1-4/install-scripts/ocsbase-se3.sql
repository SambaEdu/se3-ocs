...
CREATE TABLE IF NOT EXISTS dico_cat(
  NAME VARCHAR(255) NOT NULL,
...
INSERT IGNORE INTO `config` VALUES ('FREQUENCY', 0, '', 'Specify the frequency (days) of inventories. (0: inventory at each login. -1: no inventory)');
INSERT IGNORE INTO `config` VALUES ('PROLOG_FREQ', 24, '', 'Specify the frequency (hours) of prolog, on agents');
